...
import CinemaPage from './cinema.js'
    ...
    return (
      <React.Fragment>
        ...
        <Modal isActive={isActive}>
          ...
          <Modal.Card>
            <Modal.Card.Head>
              <Modal.Card.Title>Cinema service sitting</Modal.Card.Title>
...
export default class MainCinemaPage extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      valueWidgetClock: [],
    ...
    return (
      <Columns>
          <Column>
            <Columns>
              <Column>
                <WeatherClose closeSrevice={this.receiveHiden} nameService='cinemaClose'/>
            ...
            <Columns>
              {this.state.valueWidgetClock.map((v) => {
                return <CinemaPage id={v} nb={this.state.valueWidgetClock} closeWidget={this.handledelTodoItem.bind(this, v, this.state.valueWidgetClock)}/>
              })}
            </Columns>
          </Column>
      </Columns>
